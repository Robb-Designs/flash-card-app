...
3. Keep changes aligned with architecture and accessibility docs.
4. Submit a pull request with clear change notes.

Recommended before PR:

- Verify desktop and mobile behavior.
- Verify keyboard navigation and modal focus handling.
- Verify theme toggle and reduced-motion behavior.

## License

No license file is currently included.

If you plan to publish this publicly, add a `LICENSE` file (for example, MIT) and update this section accordingly.
